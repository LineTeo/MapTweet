...
## アップデート
- 2026-03-16:演習アプリを改造して、地図APIの利用と、データをXML形式ファイルに保存する機能を追加した初版作成
- 2026-03-17:JDBC演習用にSQL データベース（H2 Database）へ移行    
- 2026-03-18:パスワードのハッシュ化（BCrypt）
- 2026-03-19:ユーザー登録情報の編集機能追加、他
- 2026-03-20:セキュリティ対策（セッション固定攻撃対策、CSRF対策、PRGパターンの適用）の実装
- 2026-03-21:投稿した自分のつぶやきの修正、削除機能追加　⇒ サーブレット演習版としての完成版 

---

## 将来の拡張案（あげればきりがないが、今後はPython演習を優先するので、当面は手を付けない）
- 1画面のつぶやき表示数（ページネーション）
- 入力バリデーション強化
